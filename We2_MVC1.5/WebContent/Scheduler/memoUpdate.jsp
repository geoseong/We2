...
<body>
 ...
 <form name="frm" method="post" action="/We2/DateUpdate.do" >
 ...
 <table>
  ...
  <tr>
   <td align="center" colspan=5>
    ...
    <input name="delete" type="button"  value="삭제"  onclick="location.href='DateDelete.do?calendarmemo_num='+${calendarmemo.calendarmemo_num}">
