		...
		<ul class="content_list">
			...
			<a  href="javascript:winOpen('${roomshare.rcode}')">   
			 	<%-- <a href="Content.do?rcode=${roomshare.rcode}"> --%> 
					...
					<a  href="javascript:winOpen2('${roomshare.rcode}')">수정하기</a> <a  href="javascript:winOpen3('${roomshare.rcode}')">삭제하기</a></p>				
				</li>
