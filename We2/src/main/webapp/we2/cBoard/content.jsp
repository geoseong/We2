			...
			<form:hidden path="category" value="${category }"/> --%>
				...
				<td style="border:none; padding:0px; vertical-align: top;">
							...
							<tr>
								...
								<c:choose>
									...
									<c:otherwise>
											<!-- 기본설정경로 : 서블릿경로
												E:\JavaSmartWeb\mywork_web\.metadata\.plugins\org.eclipse.wst.server.core\tmp2\wtpwebapps -->
										<a href="/We2/we2/cBoard/data/${BoardContent.getItemPath() }"  download>${BoardContent.getItemPath() }</a>
									</c:otherwise>
								</c:choose>
								</td>
							</tr>
					...
					<td class = "modal" style="border:0.5px solid #d3d3d3;">
						<div class="modal_img"><img src="/We2/we2/cBoard/data/${BoardContent.getItemPath() }"></div> 
