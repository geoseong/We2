...
public interface CBoardMapper {
	// SQL START //
		...
		ArrayList<CBoardBean> getList(@Param("category") String category, @Param("row_start") int row_start, @Param("rows_per_page") int rows_per_page);
		...
		CBoardBean select_by_num(@Param("category") String category, @Param("itemNum")int itemNum);
		...
		ArrayList<CBoardBean> findBoard(
				@Param("category") String category, 
